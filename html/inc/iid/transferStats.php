...
// IMPORTANT: needed here otherwhise $transfer is not set
transfer_init();

if ($cfg["transmission_rpc_enable"]) {
	require_once('inc/functions/functions.rpc.transmission.php');
	$isTransTransfer = isTransmissionTransfer($transfer);
} else {
	$isTransTransfer = false;
}

if ($isTransTransfer) {
	require_once('inc/functions/functions.ui.transmission.php');
	$tmpl = transmissionSetVars($transfer, $tmpl);
} else { 

	// init transfer
	//transfer_init(); // Done at the start
